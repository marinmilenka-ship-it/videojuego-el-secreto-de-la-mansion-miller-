...
vidas = 3
# ADAPTADO AL CÓDIGO 2: La posición cambia para estar dentro de la sala
checkpoint_pos = Vec3(0, 2, -8)

#CLASES Y FUNCIONES
class Mundo:
    def __init__(self):
        # ADAPTADO AL CÓDIGO 2: Sala importada desde Blender
        self.sala = Entity(
            model='sala1.glb',
            position=(0, 0, 0),
            rotation=(0, 180, 0),
        ...
        # ADAPTADO AL CÓDIGO 2: Piso invisible para evitar caídas
        self.suelo = Entity(
            model='plane',
            scale=(500, 1, 500),
            position=(0, -0.05, 0),
...
class Jugador(FirstPersonController):
    def __init__(self, inventario_ui, mundo_ref):
        super().__init__(position=(0, 2, -8)) # ADAPTADO AL CÓDIGO 2
        self.collider = 'box'
        self.enabled = False 
        ...
        self.gravity = 1               
        self.audio_pasos = Audio('pasos.mp3', autoplay=False, loop=True, volume=1) # DEL CÓDIGO 1
...
class Introduccion:
    def __init__(self, jugador_ref):
        ...
        self.audio_voz = Audio('voz_intro.mp3', autoplay=False, loop=False) # DEL CÓDIGO 1

    def iniciar(self):
        self.pantalla.enabled = True
        self.audio_voz.play() # DEL CÓDIGO 1
    ...
    def finalizar(self):
        ...
        musica_fondo.play() # DEL CÓDIGO 1

class Menu:
    def __init__(self, intro_ref):
        self.intro=intro_ref
        # ADAPTADO AL CÓDIGO 2: textura="fondo_original.jpg (1).jpeg"
...
def update():
    ...
    if intro_terminada and tiempo_restante > 0:
        ...
        if tiempo_restante <= 0:
            ...
            mouse.locked = False
            musica_fondo.stop() # DEL CÓDIGO 1
            mouse.visible = True
...
menu=Menu(intro)
musica_fondo = Audio('musica_juego.mp3', autoplay=False, loop=True, volume=0.4) # DEL CÓDIGO 1
app.run()